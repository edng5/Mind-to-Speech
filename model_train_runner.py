...
def main():
    ...
    for epoch in range(trainer.config["epochs"]):
        ...
        # Save the model checkpoint with accuracy in the filename
        ...
        # Update checkpoint filename with accuracy
    ...
    # Parse phonemes into a sentence
    print("Parsing phonemes into a sentence...")
    sentence = trainer.parse_phonemes_to_sentence(predictions)
